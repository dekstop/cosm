...
#rm "$indexfile"
echo "ID	CREATED_AT	UPDATED_AT	TITLE	FEED	STATUS	PRIVATE	LOCATION	LAT	LON	ENV_TAGS	STREAM_ID	STREAM_UNIT	STREAM_VALUE	STREAM_TIMESTAMP	STREAM_TAGS	JOINED_TAGS" > "$indexfile"
